      ...
      {credentials.length === 0 ? (
        <div style={{ display: "flex", flexDirection: "column", gap: 1, background: "var(--border)" }}>
          ...
          <div className="card animate-fade-up animate-fade-up-1" style={{ borderRadius: 0, padding: "48px 28px", textAlign: "center" }}>
            ...
            <p style={{ fontFamily: "Clash Display, sans-serif", fontWeight: 700, fontSize: 22, marginBottom: 12, letterSpacing: "-0.03em" }}>No credentials yet</p>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              {[
                ...
                <div key={s.n} style={{ display: "flex", gap: 20, alignItems: "flex-start" }}>
                  <span style={{ fontFamily: "Clash Display, sans-serif", fontWeight: 700, fontSize: 11, color: "var(--accent)", flexShrink: 0, marginTop: 2, letterSpacing: "0.1em" }}>{s.n}</span>
          ...
          <div className="card animate-fade-up animate-fade-up-4" style={{ borderRadius: 0, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 }}>
            <div>
              <p style={{ fontFamily: "Clash Display, sans-serif", fontWeight: 700, fontSize: 16, letterSpacing: "-0.02em" }}>Are you an institution?</p>
        ...
        <>
          ...
          <div className="card-accent animate-fade-up animate-fade-up-1" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 }}>
            <div>
              <p style={{ fontFamily: "Clash Display, sans-serif", fontWeight: 700, fontSize: 16, letterSpacing: "-0.02em" }}>Share your credential profile</p>
              ...
              >
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 16 }}>
                  <div style={{ flex: 1 }}>
                    ...
                    <p style={{ fontSize: "clamp(18px, 3vw, 22px)", fontWeight: 700, fontFamily: "Clash Display, sans-serif", letterSpacing: "-0.02em" }}>
                  ...
                  <div style={{ textAlign: "right", flexShrink: 0 }}>
                    <p style={{ fontSize: 10, color: "var(--muted)", letterSpacing: "0.08em", textTransform: "uppercase", fontFamily: "Clash Display, sans-serif", marginBottom: 4 }}>Issued</p>
                    <p style={{ fontSize: 13, fontFamily: "Cabinet Grotesk, sans-serif", fontWeight: 500 }}>
                      {new Date(cred.issuedAt * 1000).toLocaleDateString("en-GB", { day: "numeric", month: "short", year: "numeric" })}
                    </p>
                    {cred.expiresAt > 0 && (
                      <>
                        <p style={{ fontSize: 10, color: "var(--muted)", letterSpacing: "0.08em", textTransform: "uppercase", fontFamily: "Clash Display, sans-serif", marginTop: 12, marginBottom: 4 }}>Expires</p>
                        <p style={{ fontSize: 13, fontFamily: "Cabinet Grotesk, sans-serif", fontWeight: 500 }}>
